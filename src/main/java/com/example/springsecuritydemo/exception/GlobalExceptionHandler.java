...
import com.example.springsecuritydemo.exception.security.RoleNotFoundException;
import com.example.springsecuritydemo.exception.security.UserNameAlreadyExistException;
import com.example.springsecuritydemo.exception.security.UserNameNotFoundException;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorResponse> resolveConstraintViolationException(ConstraintViolationException ex, HttpServletRequest request) {
        Map<String, Object> errors = new HashMap<>(8);
