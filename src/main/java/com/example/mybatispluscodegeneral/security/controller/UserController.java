package com.example.mybatispluscodegeneral.security.controller;
...
import com.example.mybatispluscodegeneral.security.enums.RoleType;
import com.example.mybatispluscodegeneral.security.service.IRoleService;
import com.example.mybatispluscodegeneral.security.service.IUserRoleService;
...
// ======== 2020/10/04 14:37
        ...
        public ResultBean<Boolean> signUp(@RequestBody @Valid User user) {
                ...
                Role two = iRoleService.getOne(Wrappers.lambdaQuery(Role.class)
                        .eq(Role::getName, RoleType.MANAGER.getName())
                );
